...
public abstract class TextBoxOld : Composition
{
	...
	public TextBoxOld()
	{
		...
		{
			TextComposition = new Composition()
			{
				Size = Vector2.One,
	...
	{
		App.Input.State.OnCharInput += handleTextInput;
		updateCaretVisibility();
	...
	protected virtual void KillFocus() => App.Input.ChangeFocus(null);
