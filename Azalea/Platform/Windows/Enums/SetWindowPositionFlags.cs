...
internal enum SetWindowPosFlags : uint
{
	...
	DrawFrame = 0x0020,
	/// <summary>
	/// Applies new frame styles set using the <see cref="WinAPI.SetWindowLong"/> function.
	...
	HideWindow = 0x0080,
	/// <summary>
	/// Does not activate the window. If this flag is not set, the window is activated and moved to the top of either
	/// the topmost or non-topmost group (depending on the setting of the InsertAfter parameter).
	/// </summary>
	NoActivate = 0x0010,
	/// <summary>
	...
	/// <summary> Retains the current size (ignores the width and height parameters). </summary>
	NoSize = 0x0001,
	/// <summary> Retains the current Z order (ignores the InsertAfter parameter). </summary>
	NoZOrder = 0x0004,
